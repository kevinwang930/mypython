# -*- coding: utf-8 -*-
"""
Created on Tue Apr 14 13:27:20 2020
...
from PyQt5.QtWidgets import QDialog,QApplication,QSplashScreen,QProgressBar,\
    QGroupBox,QLabel,QPushButton,QVBoxLayout,QScrollArea,QWidgetItem,QTextBrowser,\
...
class Form(QDialog):
    ...
    def __init__(self, parent=None):
        ...
        self.socket.hostFound.connect(self.hostfound)
        self.socket.connected.connect(self.hostconnected)
